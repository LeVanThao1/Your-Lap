...
async function loadCartProduct2(pd) {
        ...
        <div class="cart_content__details">
            <div class="cart_content__price">
                <span class="cart_content__price--current">${pd.price}đ</span>
                <span class="cart-content__discount-prices">
                    <span class="cart_content__price--old">${Math.ceil(pd.price * 1.2)}đ</span>
                    <span class="cart_content__discout--percent">-20%</span>
                </span>
            </div>
